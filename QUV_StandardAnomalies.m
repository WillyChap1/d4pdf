...
make_it_tight = true;
subplot = @(m,n,p) subtightplot (m, n, p, [0.01 0.05], [0.05 0.05], [0.05 0.05]);
...
fmax = cat(3,(QCompositeNino-QMean)./QplotIntNino,(QCompositeNina-QMean)./QplotIntNina,(QCompositeNoNino-QMean)./QplotIntNoNino);
cv1 = max(max(max(abs(fmax))));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
aa2=subplot(3,4,2);
padvar =4;
padCOMPmean = padarray((QCompositeNino-QMean)./QplotIntNino,[padvar,padvar],nan,'both');
...
aa3=subplot(3,4,3);
padvar =4;
padCOMPmean = padarray((QCompositeNina-QMean)./QplotIntNina,[padvar,padvar],nan,'both');
...
aa4=subplot(3,4,4);
padvar =4;
padCOMPmean = padarray((QCompositeNoNino-QMean)./QplotIntNoNino,[padvar,padvar],nan,'both');
...
fmax = cat(3,(UCompositeNino-UMean)./UplotIntNino,(UCompositeNina-UMean)./UplotIntNina,(UCompositeNoNino-UMean)./UplotIntNoNino);
...
aa6=subplot(3,4,6);
padvar =4;
padCOMPmean = padarray((UCompositeNino-UMean)./UplotIntNino,[padvar,padvar],nan,'both');
...
aa7 = subplot(3,4,7);
padvar =4;
padCOMPmean = padarray((UCompositeNina-UMean)./UplotIntNina,[padvar,padvar],nan,'both');
...
aa8=subplot(3,4,8);
padvar =4;
padCOMPmean = padarray((UCompositeNoNino-UMean)./UplotIntNoNino,[padvar,padvar],nan,'both');
...
fmax = cat(3,(VCompositeNino-VMean)./VplotIntNino,(VCompositeNina-VMean)./VplotIntNina,(VCompositeNoNino-VMean)./VplotIntNoNino);
...
aa10=subplot(3,4,10);
padvar =4;
padCOMPmean = padarray((VCompositeNino-VMean)./VplotIntNino,[padvar,padvar],nan,'both');
...
aa11 = subplot(3,4,11);
padvar =4;
padCOMPmean = padarray((VCompositeNina-VMean)./VplotIntNina,[padvar,padvar],nan,'both');
...
aa12=subplot(3,4,12);
padvar =4;
padCOMPmean = padarray((VCompositeNoNino-VMean)./VplotIntNoNino,[padvar,padvar],nan,'both');
...
figsave=strcat('/Users/wchapman/Desktop/QUVfigs/','DJF_',num2str(Level(RRa)),'_StdAnomaly.jpg');
saveas(ax11,figsave);
end
